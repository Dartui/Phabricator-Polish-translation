...
final class PhabricatorUSEnglishTranslation
	...
	protected function getTranslations() {
		// jakie? np domyślne, wbudowane itd...
		return array(
			// Miscs
			...
			'November' => 'Listopad',
			'December' => 'Grudzień',
			// http://www.rjp.pan.pl/index.php?option=com_content&view=article&id=978:skroty-nazw-miesicy&catid=44&Itemid=145
        	'Jan' => 'Sty',
			'Feb' => 'Lut',
			'Mar' => 'Mar',
			'Apr' => 'Kwi',
			...
			'Global Defaults' => 'Ustawienia domyślne',
			'Create Global Defaults' => 'Utwórz ustawienia domyślne',
			'Personal Settings' => 'Ustawienia personalne',
			'Personal Account Settings' => 'Personalne ustawienia konta',
			'Edit settings for your personal account.' => 'Edytuj personalne ustawienia dla twojego konta.',
			'Global Default Settings' => 'Domyślne ustawienia',
			'Edit global default settings for all users.' => 'Edytuj domyślne ustawienia dla wszystkich użytkowników',
				// Account
				'Account' => 'Konto',
				...
				'Date and Time' => 'Data i Czas',
					'Select your local timezone.' => 'Wybierz swoją strefę czasową.',
					'Timezone' => 'Strefa czasowa',
					'Select the format you prefer for editing dates.' =>
						'Wybierz preferowany format daty podczas edytowania.',
					'Date Format' => 'Format daty',
						'Europe: 28-02-2000' => 'Europejski: 28-02-2000',
					'Select the format you prefer for editing and displaying time.' =>
						'Wybierz preferowany format czasu podczas edytowania i wyświetlania.',
					'Time Format' => 'Format czasu',
						'12 Hour, 2:34 PM' => '12 godzinny, 2:34 PM',
						'24 Hour, 14:34' => '24 godzinny, 14:34',
					'Choose which day a calendar week should begin on.' =>
						'Wybierz od którego dnia powinien rozpoczynać się kalendarzowy tydzień.',
					'Week Starts On' => 'Dzień rozpoczynający tydzień',
				// Applications
				'Applications' => 'Aplikacje',
				'Conpherence Preferences' => 'Ustawienia Conpherence',
					'Choose the default notification behavior for Conpherence rooms.' =>
						'Wybierz domyślne zachowanie powiadomień dla pokoi Conpherence.',
					'Conpherence Notifications' => 'Powiadomienia Conpherence',
			...
			'Revisions' => 'Rewizje',
			'Commits' => 'Zaangażowanie',
			'Manage' => 'Zarządzaj',
			'User Since' => 'Użytkownik od',
			'Roles' => 'Uprawnienia',
			'Today' => 'Dziś',
			'Yesterday' => 'Wczoraj',
